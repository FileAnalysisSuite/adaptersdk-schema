...
namespace MicroFocus.FAS.AdapterSdkSchema
{
    ...
    public sealed class AdapterSdkSchemaObjectBuilder
    {
        ...
        {
            _schemaObjectBuilder.SetStringFieldValue(AdapterSdkSchema.TYPE, value);
            _isTypeSet = true;
        }

        public void ClearType()
        {
            _schemaObjectBuilder.ClearField(AdapterSdkSchema.TYPE);
            _isTypeSet = false;
        }
        ...
        public void Validate()
        {
            ...
            if (!_isTypeSet)
            {
                throw new ArgumentException("Mandatory field 'AdapterSdkSchema.TYPE' is not set");
            }
        }
