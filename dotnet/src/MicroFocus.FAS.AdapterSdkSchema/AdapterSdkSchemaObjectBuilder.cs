...
namespace MicroFocus.FAS.AdapterSdkSchema
{
    ...
    public sealed class AdapterSdkSchemaObjectBuilder
    {
        ...
        public void SetCreatedBy(params string[] values)
        {
            _schemaObjectBuilder.SetStringFieldValue(AdapterSdkSchema.CREATED_BY, values);
        }

        public void SetCreatedBy(List<System.String> values)
        {
            _schemaObjectBuilder.SetStringFieldValue(AdapterSdkSchema.CREATED_BY, values);
        }
        ...
        {
            _schemaObjectBuilder.AddStringFieldValue(AdapterSdkSchema.CREATED_BY, value);
        }

        public void SetCreatedBy(string value)
        {
            _schemaObjectBuilder.SetStringFieldValue(AdapterSdkSchema.CREATED_BY, value);
        }

        public void ClearCreatedBy()
        {
            _schemaObjectBuilder.ClearField(AdapterSdkSchema.CREATED_BY);
        }
        ...
        public void SetDateLastAccessed(System.DateTime value)
        {
            _schemaObjectBuilder.SetInstantFieldValue(AdapterSdkSchema.DATE_LAST_ACCESSED, value);
        }

        public void ClearDateLastAccessed()
        {
            _schemaObjectBuilder.ClearField(AdapterSdkSchema.DATE_LAST_ACCESSED);
        }
        ...
        {
            _schemaObjectBuilder.SetStringFieldValue(AdapterSdkSchema.LAST_MODIFIED_BY, value);
        }

        public void ClearLastModifiedBy()
        {
            _schemaObjectBuilder.ClearField(AdapterSdkSchema.LAST_MODIFIED_BY);
        }

        public void SetMessageId(params string[] values)
        {
            _schemaObjectBuilder.SetStringFieldValue(AdapterSdkSchema.MESSAGE_ID, values);
        }

        public void SetMessageId(List<System.String> values)
        {
            _schemaObjectBuilder.SetStringFieldValue(AdapterSdkSchema.MESSAGE_ID, values);
        }
        ...
        {
            _schemaObjectBuilder.AddStringFieldValue(AdapterSdkSchema.MESSAGE_ID, value);
        }
        ...
        public void SetMipLabels(Action<MipLabelsObjectBuilder> director)
        {
            _schemaObjectBuilder.SetFlattenedFieldValue(AdapterSdkSchema.MIP_LABELS, sBuilder =>
            {
                MipLabelsObjectBuilder mipLabelsBuilder = new MipLabelsObjectBuilder(sBuilder);
                director.Invoke(mipLabelsBuilder);
                mipLabelsBuilder.Validate();
            });
        }

        public void SetMipLabels(params Action<MipLabelsObjectBuilder>[] directors)
        {
            SetMipLabels(directors.ToList());
        }

        public void SetMipLabels(IEnumerable<Action<MipLabelsObjectBuilder>> directors)
        {
            _schemaObjectBuilder.SetFlattenedFieldValue(AdapterSdkSchema.MIP_LABELS, directors.Select<Action<MipLabelsObjectBuilder>, Action<ISchemaObjectBuilder>>(director =>
            {
                return sBuilder =>
                {
                    MipLabelsObjectBuilder mipLabelsBuilder = new MipLabelsObjectBuilder(sBuilder);
        ...
        {
            _schemaObjectBuilder.ClearField(AdapterSdkSchema.MIP_LABELS);
        }
        ...
        public void SetOwnedBy(params string[] values)
        {
            _schemaObjectBuilder.SetStringFieldValue(AdapterSdkSchema.OWNED_BY, values);
        }

        public void SetOwnedBy(List<System.String> values)
        {
            _schemaObjectBuilder.SetStringFieldValue(AdapterSdkSchema.OWNED_BY, values);
        }

        public void AddOwnedBy(string value)
        {
            _schemaObjectBuilder.AddStringFieldValue(AdapterSdkSchema.OWNED_BY, value);
        }

        public void SetOwnedBy(string value)
        {
            _schemaObjectBuilder.SetStringFieldValue(AdapterSdkSchema.OWNED_BY, value);
        }

        public void ClearOwnedBy()
        {
            _schemaObjectBuilder.ClearField(AdapterSdkSchema.OWNED_BY);
        }
        ...
        public void SetSecurityAttributes(Action<SecurityAttributesObjectBuilder> director)
        {
            _schemaObjectBuilder.SetFlattenedFieldValue(AdapterSdkSchema.SECURITY_ATTRIBUTES, sBuilder =>
            {
                SecurityAttributesObjectBuilder securityAttributesBuilder = new SecurityAttributesObjectBuilder(sBuilder);
                director.Invoke(securityAttributesBuilder);
        ...
        {
            _schemaObjectBuilder.ClearField(AdapterSdkSchema.SECURITY_ATTRIBUTES);
        }
        ...
        public void SetTableMetadata(Action<TableMetadataObjectBuilder> director)
        {
            TableMetadataObjectBuilder tableMetadataBuilder = new TableMetadataObjectBuilder();
            director.Invoke(tableMetadataBuilder);
            _schemaObjectBuilder.SetJsonFieldValue(AdapterSdkSchema.TABLE_METADATA, jsonBuilder =>
            {
        ...
        {
            _schemaObjectBuilder.ClearField(AdapterSdkSchema.TABLE_METADATA);
        }
        ...
        public void SetUniqueVersionId(string value)
        {
            _schemaObjectBuilder.SetStringFieldValue(AdapterSdkSchema.UNIQUE_VERSION_ID, value);
        }

        public void ClearUniqueVersionId()
        {
            _schemaObjectBuilder.ClearField(AdapterSdkSchema.UNIQUE_VERSION_ID);
        }

        public void SetUrlPath(string value)
        {
            _schemaObjectBuilder.SetStringFieldValue(AdapterSdkSchema.URL_PATH, value);
        }

        public void ClearUrlPath()
        {
            _schemaObjectBuilder.ClearField(AdapterSdkSchema.URL_PATH);
        }

        public void SetUrlPathIds(string value)
        {
            _schemaObjectBuilder.SetStringFieldValue(AdapterSdkSchema.URL_PATH_IDS, value);
        }

        public void ClearUrlPathIds()
        {
            _schemaObjectBuilder.ClearField(AdapterSdkSchema.URL_PATH_IDS);
        }
        ...
        public sealed class MipLabelsObjectBuilder
        {
            private readonly ISchemaObjectBuilder _schemaObjectBuilder;
            internal MipLabelsObjectBuilder(ISchemaObjectBuilder schemaObjectBuilder)
            {
                this._schemaObjectBuilder = schemaObjectBuilder;
            }
            ...
            {
                _schemaObjectBuilder.SetStringFieldValue(AdapterSdkSchema.MIP_LABELS.SITE_ID, value);
            }

            public void ClearSiteId()
            {
                _schemaObjectBuilder.ClearField(AdapterSdkSchema.MIP_LABELS.SITE_ID);
            }

            public void SetId(string value)
            {
                _schemaObjectBuilder.SetStringFieldValue(AdapterSdkSchema.MIP_LABELS.ID, value);
            }

            public void ClearId()
            {
                _schemaObjectBuilder.ClearField(AdapterSdkSchema.MIP_LABELS.ID);
            }

            public void SetSetdate(System.DateTime value)
            {
                _schemaObjectBuilder.SetInstantFieldValue(AdapterSdkSchema.MIP_LABELS.SETDATE, value);
            }

            public void ClearSetdate()
            {
                _schemaObjectBuilder.ClearField(AdapterSdkSchema.MIP_LABELS.SETDATE);
            }

            public void SetName(string value)
            {
                _schemaObjectBuilder.SetStringFieldValue(AdapterSdkSchema.MIP_LABELS.NAME, value);
            }

            public void ClearName()
            {
                _schemaObjectBuilder.ClearField(AdapterSdkSchema.MIP_LABELS.NAME);
            }

            public void SetIsEncrypted(bool value)
            {
                _schemaObjectBuilder.SetBooleanFieldValue(AdapterSdkSchema.MIP_LABELS.IS_ENCRYPTED, value);
            }

            public void ClearIsEncrypted()
            {
                _schemaObjectBuilder.ClearField(AdapterSdkSchema.MIP_LABELS.IS_ENCRYPTED);
            }
        ...
        public sealed class SecurityAttributesObjectBuilder
        {
            private readonly ISchemaObjectBuilder _schemaObjectBuilder;
            internal SecurityAttributesObjectBuilder(ISchemaObjectBuilder schemaObjectBuilder)
            {
                this._schemaObjectBuilder = schemaObjectBuilder;
            }

            public void SetAllowedGroups(params string[] values)
            {
                _schemaObjectBuilder.SetStringFieldValue(AdapterSdkSchema.SECURITY_ATTRIBUTES.ALLOWED_GROUPS, values);
            }

            public void SetAllowedGroups(List<System.String> values)
            {
                _schemaObjectBuilder.SetStringFieldValue(AdapterSdkSchema.SECURITY_ATTRIBUTES.ALLOWED_GROUPS, values);
            }

            public void AddAllowedGroups(string value)
            {
                _schemaObjectBuilder.AddStringFieldValue(AdapterSdkSchema.SECURITY_ATTRIBUTES.ALLOWED_GROUPS, value);
            }

            public void SetAllowedGroups(string value)
            {
                _schemaObjectBuilder.SetStringFieldValue(AdapterSdkSchema.SECURITY_ATTRIBUTES.ALLOWED_GROUPS, value);
            }

            public void ClearAllowedGroups()
            {
                _schemaObjectBuilder.ClearField(AdapterSdkSchema.SECURITY_ATTRIBUTES.ALLOWED_GROUPS);
            }
        ...
        public sealed class TableMetadataObjectBuilder
        {
            private bool? isShuffled;
            private int? sampleRowCount;
            internal TableMetadataObjectBuilder()
            {
            }

            public void SetIsShuffled(bool value)
            {
            ...
            public void SetSampleRowCount(int value)
            {
            ...
            internal void Build(IJsonBuilder jsonBuilder)
            {
                ...
                if (isShuffled == null)
                {
                    throw new ArgumentException("Mandatory field 'AdapterSdkSchema.TABLE_METADATA.IS_SHUFFLED' is not set");
                }
                else
                {
                    jsonBuilder.WriteFieldName(AdapterSdkSchema.TABLE_METADATA.IS_SHUFFLED.FieldName);
                    jsonBuilder.WriteBoolean(isShuffled.Value);
                }

                if (sampleRowCount == null)
                {
                    throw new ArgumentException("Mandatory field 'AdapterSdkSchema.TABLE_METADATA.SAMPLE_ROW_COUNT' is not set");
                }
                else
                {
                    jsonBuilder.WriteFieldName(AdapterSdkSchema.TABLE_METADATA.SAMPLE_ROW_COUNT.FieldName);
                    jsonBuilder.WriteInteger(sampleRowCount.Value);
                }
