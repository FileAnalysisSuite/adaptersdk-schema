...
namespace MicroFocus.FAS.AdapterSdkSchema
{
    ...
    public sealed class AdapterSdkSchemaObjectBuilder
    {
        ...
        public void SetDateDeleted(System.DateTime value)
        {
            _schemaObjectBuilder.SetInstantFieldValue(AdapterSdkSchema.DATE_DELETED, value);
        }

        public void ClearDateDeleted()
        {
            _schemaObjectBuilder.ClearField(AdapterSdkSchema.DATE_DELETED);
        }
