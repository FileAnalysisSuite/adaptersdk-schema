...
namespace MicroFocus.FAS.AdapterSdkSchema
{
    public static class AdapterSdkSchema
    {
        ...
        public static readonly IField CREATED_BY = new FieldImpl("CREATED_BY", "STRING", null, true, false, true, false);
        ...
        public static readonly IField DATE_LAST_ACCESSED = new FieldImpl("DATE_LAST_ACCESSED", "DATETIME", null, false, false, false, false);
        ...
        public static readonly IField HASH = new FieldImpl("HASH", "STRING", null, false, false, false, false);
        public static readonly IField IS_OLE = new FieldImpl("IS_OLE", "BOOLEAN", null, false, false, false, false);
        public static readonly IField LAST_MODIFIED_BY = new FieldImpl("LAST_MODIFIED_BY", "STRING", null, false, false, true, false);
        public static readonly IField MESSAGE_ID = new FieldImpl("MESSAGE_ID", "STRING", null, true, false, false, false);
        ...
        public static readonly MipLabelsField MIP_LABELS = new MipLabelsField();
        public static readonly OcrField OCR = new OcrField();
        public static readonly IField OWNED_BY = new FieldImpl("OWNED_BY", "STRING", null, true, false, true, false);
        ...
        public static readonly SecurityAttributesField SECURITY_ATTRIBUTES = new SecurityAttributesField();
        public static readonly IField SOURCE_REFERENCE = new FieldImpl("SOURCE_REFERENCE", "STRING", null, false, false, false, false);
        public static readonly TableMetadataField TABLE_METADATA = new TableMetadataField();
        ...
        public static readonly IField UNIQUE_VERSION_ID = new FieldImpl("UNIQUE_VERSION_ID", "STRING", null, false, false, false, false);
        public static readonly IField URL_PATH = new FieldImpl("URL_PATH", "STRING", null, false, false, false, false);
        public static readonly IField URL_PATH_IDS = new FieldImpl("URL_PATH_IDS", "STRING", null, false, false, false, false);
        public static IField GetField(string fieldName)
        {
            switch (fieldName)
            {
                ...
                case "MIP_LABELS.IS_ENCRYPTED":
                    return MIP_LABELS.IS_ENCRYPTED;
                case "OCR":
                    return OCR;
                case "OCR.CONFIDENCE":
                ...
                case "SECURITY_ATTRIBUTES.ALLOWED_GROUPS":
                    return SECURITY_ATTRIBUTES.ALLOWED_GROUPS;
        ...
        public class MipLabelsField : IStructuredField
        {
            private readonly IField field;
            public readonly ISubfield SITE_ID;
            public readonly ISubfield ID;
            public readonly ISubfield SETDATE;
            public readonly ISubfield NAME;
            public readonly ISubfield IS_ENCRYPTED;
            public string FieldName => field.FieldName;
            public string FieldType => field.FieldType;
            public ObjectEncoding? ObjectEncoding => field.ObjectEncoding;
            public IField ParentField => field.ParentField;
            ...
            public bool IsCaseInsensitive => field.IsCaseInsensitive;
            public bool IsTokenizedPath => field.IsTokenizedPath;
            internal MipLabelsField()
            {
                this.field = new FieldImpl("MIP_LABELS", "mip_labels", MicroFocus.FAS.AdapterSdkSchema.ObjectEncoding.Flattened, true, false, false, false);
                this.SITE_ID = new SubfieldImpl("SITE_ID", "STRING", null, false, false, false, false, this);
                this.ID = new SubfieldImpl("ID", "STRING", null, false, false, false, false, this);
                this.SETDATE = new SubfieldImpl("SETDATE", "DATETIME", null, false, false, false, false, this);
                this.NAME = new SubfieldImpl("NAME", "STRING", null, false, false, false, false, this);
                this.IS_ENCRYPTED = new SubfieldImpl("IS_ENCRYPTED", "BOOLEAN", null, false, false, false, false, this);
            }
        }
        ...
        public class SecurityAttributesField : IStructuredField
        {
            private readonly IField field;
            public readonly ISubfield ALLOWED_GROUPS;
            public string FieldName => field.FieldName;
            public string FieldType => field.FieldType;
            public ObjectEncoding? ObjectEncoding => field.ObjectEncoding;
            public IField ParentField => field.ParentField;
            ...
            public bool IsCaseInsensitive => field.IsCaseInsensitive;
            public bool IsTokenizedPath => field.IsTokenizedPath;
            internal SecurityAttributesField()
            {
                this.field = new FieldImpl("SECURITY_ATTRIBUTES", "security_attributes", MicroFocus.FAS.AdapterSdkSchema.ObjectEncoding.Flattened, false, false, false, false);
                this.ALLOWED_GROUPS = new SubfieldImpl("ALLOWED_GROUPS", "STRING", null, true, false, false, false, this);
            }
        }

        public class TableMetadataField : IStructuredField
        {
            private readonly IField field;
            public readonly ISubfield IS_SHUFFLED;
            public readonly ISubfield SAMPLE_ROW_COUNT;
            public string FieldName => field.FieldName;
            public string FieldType => field.FieldType;
            public ObjectEncoding? ObjectEncoding => field.ObjectEncoding;
            public IField ParentField => field.ParentField;
            ...
            public bool IsCaseInsensitive => field.IsCaseInsensitive;
            public bool IsTokenizedPath => field.IsTokenizedPath;
            internal TableMetadataField()
            {
                this.field = new FieldImpl("TABLE_METADATA", "table_metadata", MicroFocus.FAS.AdapterSdkSchema.ObjectEncoding.Json, false, false, false, false);
                this.IS_SHUFFLED = new SubfieldImpl("IS_SHUFFLED", "BOOLEAN", null, false, true, false, false, this);
                this.SAMPLE_ROW_COUNT = new SubfieldImpl("SAMPLE_ROW_COUNT", "INTEGER", null, false, true, false, false, this);
            }
        }
    }
}