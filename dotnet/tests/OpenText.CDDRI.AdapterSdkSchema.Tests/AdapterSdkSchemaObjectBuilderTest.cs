...
using OpenText.CDDRI.AdapterSdkSchema.SchemaObjectBuilders;
using OpenText.CDDRI.AdapterSdkSchema.JsonBuilders.System;
using Xunit;

namespace OpenText.CDDRI.AdapterSdkSchema.Tests
{
