...
public final class AdapterSdkSchema {
  ...
  @Nonnull
  public static final Field CREATED_BY = new FieldImpl("CREATED_BY", "STRING", null, true, false, true, false);
  ...
  @Nonnull
  public static final Field DATE_LAST_ACCESSED = new FieldImpl("DATE_LAST_ACCESSED", "DATETIME", null, false, false, false, false);
  ...
  @Nonnull
  public static final Field HASH = new FieldImpl("HASH", "STRING", null, false, false, false, false);

  @Nonnull
  public static final Field IS_OLE = new FieldImpl("IS_OLE", "BOOLEAN", null, false, false, false, false);

  @Nonnull
  public static final Field LAST_MODIFIED_BY = new FieldImpl("LAST_MODIFIED_BY", "STRING", null, false, false, true, false);

  @Nonnull
  public static final Field MESSAGE_ID = new FieldImpl("MESSAGE_ID", "STRING", null, true, false, false, false);
  ...
  @Nonnull
  public static final Field OWNED_BY = new FieldImpl("OWNED_BY", "STRING", null, true, false, true, false);
  ...
  @Nonnull
  public static final SecurityAttributesField SECURITY_ATTRIBUTES = new SecurityAttributesField();
  ...
  @Nonnull
  public static final Field UNIQUE_VERSION_ID = new FieldImpl("UNIQUE_VERSION_ID", "STRING", null, false, false, false, false);

  @Nonnull
  public static final Field URL_PATH = new FieldImpl("URL_PATH", "STRING", null, false, false, false, false);

  @Nonnull
  public static final Field URL_PATH_IDS = new FieldImpl("URL_PATH_IDS", "STRING", null, false, false, false, false);
  ...
  public static final class MipLabelsField extends FieldImpl implements StructuredField {
    ...
    @Nonnull
    public final Subfield IS_ENCRYPTED = new SubfieldImpl("IS_ENCRYPTED", "BOOLEAN", null, false, false, false, false, this);
  ...
  public static final class SecurityAttributesField extends FieldImpl implements StructuredField {
    @Nonnull
    public final Subfield ALLOWED_GROUPS = new SubfieldImpl("ALLOWED_GROUPS", "STRING", null, true, false, false, false, this);

    private SecurityAttributesField() {
      super("SECURITY_ATTRIBUTES", "security_attributes", Field.ObjectEncoding.FLATTENED, false, false, false, false);
    }
  }
