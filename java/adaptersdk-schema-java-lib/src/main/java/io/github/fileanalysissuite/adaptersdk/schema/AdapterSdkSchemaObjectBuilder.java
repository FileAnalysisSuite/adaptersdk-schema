...
public final class AdapterSdkSchemaObjectBuilder {
  ...
  public void setType(final String value) {
    schemaObjectBuilder.setStringFieldValue(AdapterSdkSchema.TYPE, value);
    isTypeSet = true;
  }

  public void clearType() {
    schemaObjectBuilder.clearField(AdapterSdkSchema.TYPE);
    isTypeSet = false;
  }
  ...
  public void validate() {
    ...
    if (!isTypeSet) {
      throw new IllegalArgumentException("Mandatory field 'AdapterSdkSchema.TYPE' is not set");
    }
  }
