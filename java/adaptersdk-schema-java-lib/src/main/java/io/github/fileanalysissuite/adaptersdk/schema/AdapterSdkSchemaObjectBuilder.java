...
public final class AdapterSdkSchemaObjectBuilder {
  ...
  public void setDateDeleted(final Instant value) {
    schemaObjectBuilder.setInstantFieldValue(AdapterSdkSchema.DATE_DELETED, value);
  }

  public void clearDateDeleted() {
    schemaObjectBuilder.clearField(AdapterSdkSchema.DATE_DELETED);
  }
  ...
  public void validate() {
    ...
    if (!isHashSet) {
      throw new IllegalArgumentException("Mandatory field 'AdapterSdkSchema.HASH' is not set");
    }
    if (!isMimetypeSet) {
