...
public final class TestSchema {
  ...
  public static Field getField(final String fieldName) {
    switch (fieldName) {
      ...
      case "ENTITIES.MATCHES.EGRAMMARS":
        return ENTITIES.MATCHES.EGRAMMARS;
      case "ENTITIES.MATCHES.EGRAMMARS.GCONTEXT":
        return ENTITIES.MATCHES.EGRAMMARS.GCONTEXT;
      case "ENTITIES.MATCHES.EGRAMMARS.GVALUE":
        return ENTITIES.MATCHES.EGRAMMARS.GVALUE;
      ...
      case "TEST.TEST_ID":
        return TEST.TEST_ID;
      case "TEST.TEST_MATCHES":
        return TEST.TEST_MATCHES;
      case "TEST.TEST_MATCHES.TYPE":
  ...
  public static final class EntitiesField extends FieldImpl implements StructuredField {
    ...
    private EntitiesField() {
      super("ENTITIES", "entity_details", Field.ObjectEncoding.FLATTENED, true, false, false, false);
    }
    ...
    public final class MatchesField extends SubfieldImpl implements StructuredSubfield {
      ...
      @Nonnull
      public final EgrammarsField EGRAMMARS = new EgrammarsField();
      ...
      public final class EgrammarsField extends SubfieldImpl implements StructuredSubfield {
        @Nonnull
        public final Subfield GCONTEXT = new SubfieldImpl("GCONTEXT", "STRING", null, true, false, false, false, this);

        @Nonnull
        public final Subfield GVALUE = new SubfieldImpl("GVALUE", "STRING", null, false, false, false, false, this);

        private EgrammarsField() {
          super("EGRAMMARS", "entity_details_grammars", Field.ObjectEncoding.FLATTENED, true, false, false, false, MatchesField.this);
        }
      }
    }
  }
  ...
  public static final class TestField extends FieldImpl implements StructuredField {
    @Nonnull
    public final Subfield TEST_ID = new SubfieldImpl("TEST_ID", "STRING", null, false, false, false, false, this);

    @Nonnull
    public final TestMatchesField TEST_MATCHES = new TestMatchesField();

    private TestField() {
      super("TEST", "test_entity", Field.ObjectEncoding.FLATTENED, true, false, false, false);
    }

    public final class TestMatchesField extends SubfieldImpl implements StructuredSubfield {
      @Nonnull
      public final Subfield TYPE = new SubfieldImpl("TYPE", "STRING", null, false, false, false, false, this);

      @Nonnull
      public final Subfield VALUE = new SubfieldImpl("VALUE", "FULLTEXT", null, false, false, false, false, this);
