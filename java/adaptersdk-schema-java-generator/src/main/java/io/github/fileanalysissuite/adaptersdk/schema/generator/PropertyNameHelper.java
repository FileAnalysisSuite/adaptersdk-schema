...
final class PropertyNameHelper
{
    public final String propertyName, ucPropertyName, sanitizedPropertyName;

    public PropertyNameHelper(
        final String propertyName,
        final String ucPropertyName,
        final String sanitizedPropertyName
    )
    {
