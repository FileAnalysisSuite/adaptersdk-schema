...
final class SchemaObjectBuilderGenerator
{
    ...
    public boolean process()
    {
        final TypeSpec.Builder schemaClassBuilder
            = createSchemaObjectBuilderClass(BUILDER_CLASS_NAME, null, schemaNode.get("fields"), new String[0], new String(), true, false);
    ...
    )
    {
        ...
        addEntityTypeObjectBuilderClass(
            objectBuilderClassBuilder, objBuilderClassName, buildFunctionBuilder, subentityDef, newPath, fullName, isFlattened);
